...
epitopes <- readRDS("~/Downloads/LBCE_datasets_20240705/epitopes.rds") # Generated by get_IEDB() followed by get_LBCE()
proteins <- readRDS("~/Downloads/LBCE_datasets_20240705/proteins_2024-07-09.rds") # Generated by get_proteins()
taxonomy <- readRDS("~/Downloads/LBCE_datasets_20240705/taxonomy.rds") # Generated by get_taxonomy()
